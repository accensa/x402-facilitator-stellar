...
| `GET /settlements/:idempotencyKey/events` | API key | no | open | Full, ordered event history for one settlement (#130) — the audit record, scoped identically to the settlement it belongs to. |
